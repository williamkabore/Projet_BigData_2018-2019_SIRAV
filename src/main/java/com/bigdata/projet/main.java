...
public class main {
	...
	public static void main(String[] args) {
		...
		System.out.println("Projet Big Data 2018-2019-Master : SIRAV\n");
		System.out.println("Réalisé par : Aziz BEKKI et William KABORE\n");
		...
		//la DataFrame dsClean sera utiliser de nombreuses fois aucour du programme. Nous allons donc utiliser une persistance pour accélerer l'exécution de notre programme.
		dsClean.persist();
		dsClean.show(10);
		...
		User_Connex.toDF("Utilisateurs et connexions").show();

        System.out.println("2.a. Nombre de d'authentifications (Logon,...) avec ou sans succès (succès / échec) pour chaque utilisateur");
        Dataset<Row> UserLogon = partie2.GroupConnex(dsClean, "utilisateur_source@domaine", "orientation d'authentification","succès / échec", "Connexion");
        ...
        Dataset<Row> User_Logon  = partie2.ColUnion(UserLogon, "utilisateur_source@domaine", "Connexion", "utilisateurs et statue de connexions");
        User_Logon.toDF("Utilisateurs et connexions").show();
        ...
        Host_Logon.toDF("Utilisateurs et connexions").show(); 
        ...
        try {
			...
			System.out.println("Veuillez spécifier le chemin du output");
		}
